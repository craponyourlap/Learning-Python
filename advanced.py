...
@log_function
def my_function(x, y):          # equivalent:
    return x + y                # def my_function(x,y):
                                #   return x+y
...
def log_function(func):
    ...
    def wrapper(*args, **kwargs):
        print('Entering this function ->', func.__name__)
        result = func(*args, **kwargs)
        print('Exiting this function ->', func.__name__)
        return result
    return wrapper
...
my_function(1, 2)    # => "Entering this function -> my_function"
                            # => "3"
                            # => "Exiting this function -> my_function"
